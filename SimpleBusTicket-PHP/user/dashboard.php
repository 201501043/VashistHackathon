...
<h3 href="" style="float:left;"><?php echo ($data->bus_no ); echo($data->route_cities) ?></h3><form action="seat.php" method="post"><input type="submit" name ="bus_no" value=<?php echo $data->bus_no?>></form><br>
<?php }  ?>
<script>
